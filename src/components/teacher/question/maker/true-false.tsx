  ...
  return (
    <form className="section-container">
      ...
      <Box>
        ...
        <Radio.Group name="answer" className="w-full" defaultValue="true">
          <Radio value="true" className="zaui-border-gray-30 zaui-bg-steelblue-20">
            <Input value="Đúng" readOnly />
          </Radio>
          <Radio value="false" className="zaui-border-gray-30 zaui-bg-steelblue-20">
      ...
      <Input
        ...
        value="Trắc nghiệm 4 đáp án" readOnly
      />
