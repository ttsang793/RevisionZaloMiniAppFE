...
import { Checkbox, Input, Select, Text, Box } from "zmp-ui";
...
const QuestionMakerConstructedResponse = () => {
  ...
  return (
    <form>
      ...
      <TextArea
        label={<Text className="mt-2">Lời giải/Giải thích <span className="zaui-text-red-50">*</span></Text>}
      ...
      <Checkbox.Group className="mt-2">
        <Checkbox id="allow-take-pic" value="true">
