...
var Link = React53.forwardRef(function LinkWithRef2(_ref7, ref) {
  ...
  return (
    ...
    React53.createElement("a", _extends5({}, rest, {
...
function useSearchParams(defaultInit) {
  ...
  let defaultSearchParamsRef = React53.useRef(createSearchParams(defaultInit));
  let hasSetSearchParamsRef = React53.useRef(false);
  let location = useLocation();
  let searchParams = React53.useMemo(() => (
  ...
  let navigate = useNavigate();
  let setSearchParams = React53.useCallback((nextInit, navigateOptions) => {
