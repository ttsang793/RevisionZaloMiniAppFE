...
var _excluded = ["onChange", "onFocus", "onBlur", "onPressEnter", "onKeyDown", "disabled", "className", "defaultValue", "status", "size", "autoHeight"];
...
var TextArea = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  ...
  var getInputElement = function getInputElement() {
    ...
    return /*#__PURE__*/_react["default"].createElement("textarea", (0, _extends2["default"])({}, otherProps, {
      ...
      className: (0, _clsx["default"])(inputPrefixCls, (_classNames = {}, _classNames[inputPrefixCls + "-small"] = mergedSize === "small", _classNames[inputPrefixCls + "-medium"] = mergedSize === "medium", _classNames[inputPrefixCls + "-large"] = mergedSize === "large", _classNames[inputPrefixCls + "-disabled"] = mergedDisabled, _classNames), !!value && (0, _statusUtils.getStatusClassNames)(inputPrefixCls, mergedStatus), inputClassName, (_classNames2 = {}, _classNames2[prefixCls + "-min-height"] = !mergedSize, _classNames2[prefixCls + "-has-show-count"] = rest.showCount, _classNames2), className),
      ref: textareaRef
    }));
  };
