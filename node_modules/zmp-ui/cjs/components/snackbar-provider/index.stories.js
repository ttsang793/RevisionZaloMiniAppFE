...
exports["default"] = exports.WithIcon = exports.WithAction = exports.Warning = exports.VerticalAction = exports.Success = exports.Loading = exports.Forerver = exports.Error = exports.Download = exports.DisconnectWifi = exports.DefaultTop = exports.Default = exports.Countdown = exports.ConnectWifi = void 0;
...
function generateStory(props) {
  return {
    name: props.name,
    args: {
      children: /*#__PURE__*/(0, _react.createElement)(function () {
        var _useSnackbar = (0, _.useSnackbar)(),
...
var Default = exports.Default = generateStory({
  name: "Mặc định",
  options: {
    text: "Thông báo này sẽ biến mất sau 2 giây"
  }
});
var Forerver = exports.Forerver = generateStory({
  name: "Vô thời hạn",
  options: {
...
var WithIcon = exports.WithIcon = generateStory({
  name: "Có biểu tượng",
  options: {
    icon: true,
...
var WithAction = exports.WithAction = generateStory({
  name: "Có hành động",
  options: {
    icon: true,
    text: "Đã lưu.",
...
var VerticalAction = exports.VerticalAction = generateStory({
  name: "Hành động dọc",
  options: {
...
var DefaultTop = exports.DefaultTop = generateStory({
...
var Error = exports.Error = generateStory({
  name: "Lỗi",
  options: {
...
var Success = exports.Success = generateStory({
  name: "Thành công",
  options: {
...
var Warning = exports.Warning = generateStory({
  name: "Cảnh báo",
  options: {
...
var Loading = exports.Loading = generateStory({
  name: "Đang tải",
  options: {
...
var Countdown = exports.Countdown = generateStory({
  name: "Đếm ngược",
  options: {
...
var Download = exports.Download = {
  ...
  args: {
    children: /*#__PURE__*/(0, _react.createElement)(function () {
      var _useSnackbar2 = (0, _.useSnackbar)(),
...
var ConnectWifi = exports.ConnectWifi = generateStory({
  name: "Kết nối Wifi",
  options: {
...
var DisconnectWifi = exports.DisconnectWifi = generateStory({
